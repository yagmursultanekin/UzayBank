...
public interface IAccountService
{
    ...
    Task<List<TransactionDto>> GetAllTransactionsByUserIdAsync(int userId, DateTime startDate, DateTime endDate);
    
    /// <summary>Admin için: TÜM hesapları filtresiz döndürür (atanmamışlar dahil).</summary>
    Task<List<AccountDto>> GetAllAccountsForAdminAsync();
}
